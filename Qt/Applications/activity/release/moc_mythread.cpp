...
#include <memory>
#include "../../pc-action-detection/mythread.h"
...
QT_MOC_LITERAL(5, 52, 10), // "reciveData"
QT_MOC_LITERAL(6, 63, 16), // "socketDescriptor"
QT_MOC_LITERAL(7, 80, 4), // "data"
QT_MOC_LITERAL(8, 85, 13), // "captureAction"
QT_MOC_LITERAL(9, 99, 7), // "fileUrl"
QT_MOC_LITERAL(10, 107, 9), // "readyRead"
QT_MOC_LITERAL(11, 117, 12) // "disconnected"

    },
    "MyThread\0error\0\0QTcpSocket::SocketError\0"
    "socketerror\0reciveData\0socketDescriptor\0"
    "data\0captureAction\0fileUrl\0readyRead\0"
    "disconnected"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->reciveData((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::reciveData)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::captureAction)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void MyThread::reciveData(int _t1, QString _t2)
{
...
// SIGNAL 2
void MyThread::captureAction(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
